...
const Login = () => {
  ...
  const { passwordLogin, GoogleLogin } = AuthService();
  ...
  const handleGooglelogin = useGoogleLogin({
    onSuccess: (tokenResponse) => {
      handleGoogleAuthSuccess(tokenResponse);
    },
              ...
              >
                <div className="auth__right">
                  <div className="auth__right-content">
                    <h4>
                      Get rewarded for your thoughts! Take surveys, earn points,
                      and cash out with our rewards program!
                    </h4>
                    <p>Share your opinions, earn rewards!</p>
                  </div>
