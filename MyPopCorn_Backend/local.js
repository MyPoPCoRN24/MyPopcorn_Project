...
app.get('/getApiKey',auth , (req, res) => {
  try {
...
sockserver.listen(3003, () => {
  console.log("Web Socket is running on http://localhost:%d", 3003);
});
startSocket(sockserver);

const server = app.listen(port, () => {
  console.log(process.env.PLATFORM_NAME + " - Running on port : 4225");
});
